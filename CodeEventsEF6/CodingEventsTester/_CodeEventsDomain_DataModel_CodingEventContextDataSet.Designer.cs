...
namespace CodingEventsTester._CodeEventsDomain_DataModel_CodingEventContextDataSetTableAdapters {
...
SELECT MigrationId, ContextKey, Model, ProductVersion FROM __MigrationHistory WHERE (ContextKey = @ContextKey) AND (MigrationId = @MigrationId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(localdb)\\mssqllocaldb;Initial Catalog=CodeEventsDomain.DataModel.Cod" +
                "ingEventContext;Integrated Security=True";
        }
